...
console.log(id);
console.log(eCoinName);
var api = "https://api.coingecko.com/api/v3/coins/" + id + "/market_chart?vs_currency=usd&days=max";
document.title = eCoinName;
fetch(api)
    .then((resp) => resp.json())
